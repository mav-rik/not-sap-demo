<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24" style="color: rgb(var(--current-icon))">
    <defs>
      <mask id="SVG2oZHmemU">
      ...
      <mask id="SVG5KjW8XKI">
        <g fill="#fff">
          ...
          <g fill-opacity="0">
            <use href="#SVGVFoRVwOl" transform="rotate(-75 12 15)"/>
            <use href="#SVGVFoRVwOl" transform="rotate(-25 12 15)"/>
            <use href="#SVGVFoRVwOl" transform="rotate(25 12 15)"/>
            <use href="#SVGVFoRVwOl" transform="rotate(75 12 15)"/>
            <set fill="freeze" attributeName="fill-opacity" begin="1.5s" to="1"/>
            <animateTransform attributeName="transform" dur="5s" repeatCount="indefinite" type="rotate" values="0 12 15;50 12 15"/>
          </g>
        </g>
    ...
    <g fill="currentColor">
      <rect width="13" height="13" x="1" y="1" mask="url(#SVG2oZHmemU)"/>
      <path d="M-2 11h28v13h-28z" mask="url(#SVG5KjW8XKI)" transform="rotate(-45 12 12)"/>
    </g>
  </svg>
</template>
